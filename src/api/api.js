...
let getTuijianData=(disstid)=>{
  let url =`/hehe/music/api/getCdInfo?g_tk=1928093487&inCharset=utf-8&outCharset=utf-8&notice=0&format=jsonp&disstid=${disstid}&type=1&json=1&utf8=1&onlysong=0&platform=yqq&hostUin=0&needNewCode=0`
  return axios.get(url,{disstid})
}
/**********************歌手**********************/ 
let getSingersData=()=>{
...
let getSingerZhuanji=(singermid)=>{
